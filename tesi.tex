...
\input{capitoli/capitolo-2}             % Lo stage
\input{capitoli/capitolo-3}             % Gli assistenti virtuali
\input{capitoli/capitolo-4}             % L'applicazione
\input{capitoli/capitolo-5}             % Risultati e considerazioni
