...
\addtocategory{opere}{womak:cfg}


\addtocategory{web}{site:assistant}
\addtocategory{web}{site:alexa}
\addtocategory{web}{site:alexa-console}
\addtocategory{web}{site:android}
\addtocategory{web}{site:android-studio}
\addtocategory{web}{site:confronto-assistenti}
\addtocategory{web}{site:css}
\addtocategory{web}{site:dialogflow}
\addtocategory{web}{site:html}
\addtocategory{web}{site:javascript}
\addtocategory{web}{site:kotlin}
\addtocategory{web}{site:siri}
\addtocategory{web}{site:validator}
\addtocategory{web}{site:webstorm}
\addtocategory{web}{site:railroad}
...
\hypersetup{
    ...
    %linkcolor=RoyalBlue,
    %citecolor=webgreen,
    %urlcolor=Black, COMMENTATI
    linkcolor=Black,
    %citecolor=Black, COMMENTATI
    %pagecolor=RoyalBlue,
